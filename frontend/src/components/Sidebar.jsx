...
const Sidebar = () => {
  const { sidebarActive, setSidebarActive, screenSize } =
  ...
  const handleCloseSideBar = () => {
    if (sidebarActive !== undefined && screenSize <= 900) {
      setSidebarActive(false);
    }
  };
          ...
          <>
            <div className="flex justify-between items-center">
              ...
              <TooltipComponent content="Menu" position="BottomCenter">
                <CloseButton
                  callBack={() => setSidebarActive(!sidebarActive)}
                  classNames="text-xl rounded-full p-3 hover:bg-light-gray mt-4 block md:hidden"
                />
              </TooltipComponent>
            </div>
            <div className="mt-10 ">
